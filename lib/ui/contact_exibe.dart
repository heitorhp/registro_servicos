...
class ContactExibe extends StatefulWidget {

  final Contact contact;

  const ContactExibe({Key key, this.contact}) : super(key: key);
...
class _ContactPageState extends State<ContactExibe> {
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              ...
              TextField( decoration: InputDecoration(labelText: "Nº OS: "), ),
                //onChanged: (text){
                 // _userEdited = true;
                  //setState(() {
               TextField( decoration: InputDecoration(labelText: _editedContact.osQru),
                  //});
                //},
